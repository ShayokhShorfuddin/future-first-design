...
export function XIcon() {
	return (
		<svg
			...
			className="w-5 fill-stone-600 hover:fill-stone-800 xs:dark:fill-neutral-400 xs:dark:hover:fill-gray-100 transition-colors duration-200 ease-in-out"
		>
...
function MenuIcon() {
	return (
		<svg
			...
			aria-label="Open menu"
			className="size-5 dark:stroke-neutral-200"
		>
