				...
				<div>
					...
					<div className="ml-10">
						...
						<p className="dark:text-neutral-400 font-inter">
							...
							stable internet connection. Future-First Design philosophy reminds
							that to developers. Applications must be designed in such a manner
							that they achieve expected behavior using minimal resources and
							limited bandwidth.
							<br /> <br />
							...
							, it is 73.1 kB (minified + gzipped) in size and potentially takes
							up to 1.46 seconds to be downloaded by the client's browser on
							slow 3G network (50kB/s).
							<br /> <br />
